...
// Browser zoom reduces the CSS viewport, so constrained laptops/desktops use
// the same lightweight GL path as touch/mobile viewports.
const mobileMode = matchMedia(COMPACT_VIEWPORT_QUERY).matches;
